...
export interface GoingUpEventTokensInterface extends utils.Interface {
  functions: {
    ...
    "setTokenSettings(uint256,string,string,address,uint256,uint256,uint256,uint256)": FunctionFragment;
...
export interface GoingUpEventTokens extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GoingUpEventTokensInterface;
  ...
  functions: {
    ...
    setTokenSettings(
      ...
      _cantMintAfter: PromiseOrValue<BigNumberish>,
      _maxSupply: PromiseOrValue<BigNumberish>,
      _maxPerAddress: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
